...
public class SmoothCameraFollow : MonoBehaviour {
    ...
    void Apply(Transform fummTarget, Vector3 dummyCenter)
    {
    ...
    void SetUpRotation(Vector3 centerPos, Vector3 headPos)
    {
        ...
        //Calculate the project center position and top position in world space
        Ray centerRay = this.GetComponent<Camera>().ViewportPointToRay(new Vector3(0.5f, 0.5f, 1f));
        Ray topRay = this.GetComponent<Camera>().ViewportPointToRay(new Vector3(0.5f, clampHeadPositionScreenSpace, 1.0f));
